...
namespace eCommerceApp.Application.Services.Implementations.Authentication
{
    public class AuthenticationService
        ...
        IRoleManagement roleManagement, IAppLogger<AuthenticationService> logger, IMapper mapper) : IAuthenticationService
    {
        public Task<ServiceRespond> CreateUser(CreateUser user)
        {
